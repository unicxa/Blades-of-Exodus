package com.sickray.games.BoE.config;
...
public class ConfigParse{
	...
	public ConfigParse(int cellX, int cellY, int CellCount){
        ...
        try {
            if (!yamlFile.exists()) {
               ...
               JOptionPane.showMessageDialog(null, "New file has been created: " + yamlFile.getFilePath() + "\n");
            } else {
